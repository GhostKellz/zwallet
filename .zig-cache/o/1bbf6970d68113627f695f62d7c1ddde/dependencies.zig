pub const packages = struct {
    ...
    pub const @"zcrypto-0.0.0-rgQAI9hbAwB7WRH0-PNGeVMkmnvjhdSCCbojWFRyK-EQ" = struct {
        pub const build_root = "/home/chris/.cache/zig/p/zcrypto-0.0.0-rgQAI9hbAwB7WRH0-PNGeVMkmnvjhdSCCbojWFRyK-EQ";
        pub const build_zig = @import("zcrypto-0.0.0-rgQAI9hbAwB7WRH0-PNGeVMkmnvjhdSCCbojWFRyK-EQ");
        pub const deps: []const struct { []const u8, []const u8 } = &.{
        };
    };
...
pub const root_deps: []const struct { []const u8, []const u8 } = &.{
    ...
    .{ "zcrypto", "zcrypto-0.0.0-rgQAI9hbAwB7WRH0-PNGeVMkmnvjhdSCCbojWFRyK-EQ" },
